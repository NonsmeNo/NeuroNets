...
class Neuron:
    ...
    def recalculate(self, x): #правило Гроссберга
...
class NeuralNetwork:
    def __init__(self):
        ...
        self.neurons = [Neuron() for i in range(4)] #определение начальных весов
    ...
    def start(self, threshold_number):
        u = [0 for i in range(4)]  # вектор выходных сигналов
        number_wins = [0 for i in range(4)]
        for i in range(len(self.x)):
            ...
            self.neurons[j].recalculate(self.x[i])  # победитель меняет веса
